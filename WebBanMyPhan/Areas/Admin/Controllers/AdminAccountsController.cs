...
namespace WebBanMyPhan.Areas.Admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        public AdminAccountsController(soryami_MyPhamDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var soryami_MyPhamDBContext = _context.Accounts.Include(a => a.Role);
            return View(await soryami_MyPhamDBContext.ToListAsync());
        }
