...
namespace WebBanMyPhan.Models
{
    public partial class soryami_MyPhamDBContext : DbContext
    {
        public soryami_MyPhamDBContext()
        {
        }

        public soryami_MyPhamDBContext(DbContextOptions<soryami_MyPhamDBContext> options)
            : base(options)
        {
        }
...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=KIENPC; Database=soryami_MyPhamDB");
                //User Id = soryami_MyPhamDB; Password = H@kien1302;
            }
        }
        ...
        public DbSet<WebBanMyPhan.ModelViews.RegisterVM> RegisterVM { get; set; }
    }
}
